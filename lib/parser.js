    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s4 !== peg$FAILED) {
        ...
        if (s6 !== peg$FAILED) {
          ...
          if (s7 !== peg$FAILED) {
            peg$savedPos = s0;
            s0 = peg$f2.call(options, s1, s3, s6);
          } else {
            peg$currPos = s0;
            s0 = peg$FAILED;
          }
  ...
  function peg$parseCharacterClassMatcher() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s4 !== peg$FAILED) {
        ...
        peg$savedPos = s0;
        s0 = peg$f20.call(options, s2, s3, s5);
      } else {
        peg$currPos = s0;
        s0 = peg$FAILED;
      }
