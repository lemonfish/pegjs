...
function generateJS( ast, session, options ) {
        ...
        function compile( bc ) {
            ...
            function compileCall() {
                ...
                const value = f( bc[ ip + 1 ] )
                    + ".call("
                    + ( paramsLength == 0 ? "options" : "options, " )
                    + bc
    ...
    function generateWrapper( toplevelCode ) {
        ...
        function generateHeaderComment() {
            ...
            let comment = "// Origin by PEG.js v0.11.0-dev https://pegjs.org/, Modified by lemonfish@gmail.com https://github.com/lemonfish/pegjs";
